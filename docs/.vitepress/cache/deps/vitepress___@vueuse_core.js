...
// ../node_modules/.pnpm/vitepress@1.3.3_@algolia+client-search@4.24.0_@types+node@22.4.2_less@4.2.0_postcss@8.4.41_sa_iwaqa5ojhdjfnglizglw56zchi/node_modules/vitepress/lib/vue-demi.mjs
var isVue2 = false;
var isVue3 = true;
...
function usePermission(permissionDesc, options = {}) {
  ...
  const onChange = () => {
    if (permissionStatus.value) state.value = permissionStatus.value.state;
  };
